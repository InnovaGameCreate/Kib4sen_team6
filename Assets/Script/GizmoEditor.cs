...
namespace Egliss
{
    public class GizmoEditor
    {
        ...
        private static void DrawFan(FanViewer view)
        {
            ...
            Gizmos.color = view.color2;
            Mesh fanMesh2 = CreateFanMesh(view.fovX / 3, view.quality);
            Gizmos.DrawMesh(fanMesh2, pos, rot, scale);
            Gizmos.color = view.color3;
            Mesh fanMesh3 = CreateFanMesh(2*view.fovX / 3, view.quality);
            Gizmos.DrawMesh(fanMesh3, pos, rot, scale);
